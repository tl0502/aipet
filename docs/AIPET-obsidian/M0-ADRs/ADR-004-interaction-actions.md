...
**优点**
- 美术工作量可控(12 个动作 × ~30 帧/动作 = 360 帧上限,VRM animation clip 数量级则更小)
- 覆盖核心场景
...
### 正面
- 美术工作量可控:12 动作 × ~30 帧 = 360 帧上限,VRM animation clip 数量级更小,符合预算。
...
- [ ] 锁定 12 个动作 ID 的命名规范(贴合 VRM animation clip 命名 / Mixamo 标准命名)
...
| M0 决策周 | 美术 | ☑ | 12 动作清单可控,VRM 模型预留对应 animation clip |
