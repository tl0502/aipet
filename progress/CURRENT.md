...
- **Last commit**:`cefc411 feat(claude): ship-task recheck + code-audit Step 0 + gate-checker regression check`(本笔 CURRENT 同步是第 4 笔)
- **Tag**:none yet(M1 出口达成后打 `v0.M1.0`)
- **Last updated**:2026-05-04(audit-coverage P0 落地 4 笔 atomic:`91dca81` 5 份新 SOP + 报告 / `eb764d6` PostToolUse suggest-checks hook + 注册 / `cefc411` ship-task 智能建议 + code-audit Step 0 自取 + gate-checker 流程回归检查 / 本笔 CURRENT 同步)
