...
description: 实现 PRD §6 单个模块的 worker 角色。输入模块号(如 "H 人格系统")+ 当前 progress 状态。读 BASELINE → 对应模块的 ADR → 架构 v1.0 § 对应章节,拆 stories → 实现 → 写 test → 更 progress/CURRENT.md → atomic commit。
---
